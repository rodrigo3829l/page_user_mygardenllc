...
<v-app>
    <v-main>
        ...
        <v-snackbar v-model="snackbar.show" :color="snackbar.color" top variant="tonal" :timeout="snackbar.timeout">
            {{ snackbar.message }}
...
export default {
    ...
    components: {
        ...
        SplashScreen: defineAsyncComponent(() => import('@/modules/shared/components/SplashScreen.vue'))
