      ...
      <v-col cols="12" class="position-relative pa-0">
        ...
        <div class="overlay-content">
          <v-col cols="12" md="12" class="white--text text-content">
            ...
            <p>Trust us to keep your garden in the best condition.</p>
            <p>
              Our team has years of experience and guarantees quality results.
            </p>
            <v-btn color="green-darken-3" dark> Schedule a Service </v-btn>
          </v-col>
        </div>
      </v-col>
    </v-row>
...
export default {
  components: {
    About: defineAsyncComponent(
      () => import("@/modules/homeModules/pages/AboutView.vue"),
    ),
    Benefits: defineAsyncComponent(
      () => import("@/modules/homeModules/pages/BenefitsView.vue"),
    ),
    Comments: defineAsyncComponent(
      () => import("@/modules/homeModules/pages/CommentsClients.vue"),
    ),
    Faqs: defineAsyncComponent(
      () => import("@/modules/homeModules/pages/FAQSView.vue"),
    ),
    Contact: defineAsyncComponent(
      () => import("@/modules/homeModules/pages/ContacUser.vue"),
    ),
  },
  data() {
    return {
      images: [
        ...
        "https://plantesdecor.com/wp-content/uploads/2024/05/img02.jpg",
        // "https://res.cloudinary.com/dui4i9f4e/image/upload/v1697990267/logos/nhqsptfuorp4dkmutlcm.jpg"
      ],
    };
  },
...
@media (max-width: 600px) {
  ...
  .text-content h1 {
    font-size: 2.5rem;
    /* Tamaño del título en pantallas pequeñas */
  }

  .text-content p {
    font-size: 1.2rem;
    /* Tamaño del texto en pantallas pequeñas */
  }
