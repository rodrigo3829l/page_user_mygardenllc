    ...
    <div class="row">
      <div class="col-md-12">
        <div class="privacy-policy">
          ...
          <p>
            Maximo Hernández Hernández, mejor conocido como My Garden LLC, con
            domicilio en calle Pebblebrook Dr 2879, colonia Buford, GA, ciudad
            Atlanta, municipio o delegación Atlanta, c.p. 30518, en la entidad
            de Georgia, país Estados Unidos, y portal de internet
            mygarden1526@gmail.com, es el responsable del uso y protección de
            sus datos personales, y al respecto le informamos lo siguiente:
          </p>

          <h3>
            <i class="fa fa-check"></i>¿Para qué fines utilizaremos sus datos
            personales?
          </h3>
          <p>
          ...
          <ul>
            ...
            <li>
              Proporcionarle su comprobante fiscal de pago, si así lo requiere.
            </li>
            <li>
              Atender sus solicitudes y consultas relacionadas con el Portal.
            </li>
          ...
          <ul>
            <li>
              Atender quejas, sugerencias y aclaraciones, de conformidad con las
              Políticas Internas aplicables en cada caso.
            </li>
            <li>Realizar encuestas de servicio.</li>
            <li>
              Ofrecer promociones, ofertas en los servicios, así como,
          ...
          <ol>
            <li>
              <input
                ...
                id="quejas"
                name="quejas"
                value="Atender quejas, sugerencias y aclaraciones"
              />
              <label for="quejas"
                >Atender quejas, sugerencias y aclaraciones, de conformidad con
                las Políticas Internas aplicables en cada caso</label
              >
            </li>
            <li>
              <input
                ...
                id="encuestas"
                name="encuestas"
                value="Realizar encuestas de servicio"
              />
            ...
            <li>
              <input
                ...
                id="promociones"
                name="promociones"
                value="Ofrecer promociones, ofertas en los servicios, así como, publicidad en general."
              />
              <label for="promociones"
                >Ofrecer promociones, ofertas en los servicios, así como,
                publicidad en general.</label
              >
            </li>
            <li>
              <input
                ...
                id="mercadotecnia"
                name="mercadotecnia"
                value="Mercadotecnia o publicitaria"
              />
          ...
          <h3>
            <i class="fa fa-user"></i>¿Qué datos personales utilizaremos para
            estos fines?
          </h3>
          <p>
          ...
          <p>
            My Garden LLC, se compromete a no transferir a un tercero sus datos
            personales, asimismo, para garantizar la protección y
            confidencialidad ha establecido mecanismos de seguridad
            administrativos, técnicos y físicos.
          </p>

          <h3>
            <i class="fa fa-lock"></i>¿Cómo puede acceder, rectificar o cancelar
          ...
          <P
            ...
            presentar la solicitud respectiva a través del siguiente medio:</P
          >
          ...
          <P
            ...
            derechos ARCO, le informamos lo siguiente:</P
          >

          <p>
            a) ¿A través de qué medios pueden acreditar su identidad el titular
            y, en su caso, su representante, así como la personalidad este
            último?
          </p>
          ...
          <p>
            e) ¿En qué medios se pueden reproducir los datos personales que, en
            su caso, solicite?
          </p>
          ...
          <p>
            ...
            personales, que está a cargo de dar trámite a la solicitudes de
            derecho ARCO, son los siguientes:
          </p>
          <p>
            a) Nombre de la persona o departamento de datos personales: Maximo
            Hernández Hernández
          </p>
          <p>
            b) Domicilio: calle Pebblebrook Dr 2879, Colonia Buford, GA, ciudad
            Atlanta, municipio o delegación Atlanta, c.p. 30518, en la entidad
            de Georgia, país Estados Unidos
          </p>

          <h3>
            <i class="fa fa-undo"></i>Usted puede revocar su consentimiento para
          ...
          <p>
            Los motivos por los cuales hace la solicitud, ademas de la
            identificacion
          </p>
          ...
          <h3>
            <i class="fa fa-bullhorn"></i>¿Cómo Puede Limitar el Uso o
          ...
          <ul>
            ...
            <li>Teléfono</li>
            <li>
              Desde la misma página web o en la ubicación de la empresa física
            </li>
          </ul>

          <h3>
            <i class="fa fa-cookie"></i>Uso de Tecnologías de Rastreo en nuestro
            Portal de Internet
          </h3>
          <p>
            ...
            página. Los dartos personales que recabamos a travás de estas
            tecnologías, los utilizaremos para los siguientes fines:
          </p>
          <p>
            Los datos personales que recabamos a través de estas tecnologías,
            los utilizaremos para los siguientes fines:
          </p>
          <ul>
            <li>
              Con fines de contacto y registro de usuarios, además de monitorear
              el comportamiento de la página web en diversos ámbitos
            </li>
          </ul>
          <p>
          ...
          <h3>
            <i class="fa fa-edit"></i>¿Cómo Puede Conocer los Cambios en este
            Aviso de Privacidad?
          </h3>
          <p>
          ...
          <p>
            ...
            sufrir el presente aviso de privacidad, a través de: Mediante correo
            electrónico y la misma página web de la empresa.
          </p>
          <p>
          ...
          <p>
            Se enviará un correo electrónico al usuario en cuestión, además de
            informar del mismo cambio a través de una alerta en la página web.
          </p>
