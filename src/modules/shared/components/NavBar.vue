   ...
   <template>
    <v-navigation-drawer
      ...
      <v-list-item
        ...
        <v-list-item v-if="!userStore.token" prepend-icon="mdi-login" title="Login"></v-list-item>

        <div v-if="userStore.token">
          <v-list-item prepend-icon="mdi-account" title="Your Account"></v-list-item>
          <v-list-item prepend-icon="mdi-cogs" title="Your services"></v-list-item>
        </div>
        ...
        <v-list-item v-if="this.$i18n.locale === 'es'" prepend-icon="mdi-translate" title="Inglés" @click="changeLanguage('en')"></v-list-item>
        ...
        <div class="container">
          <v-row align="center" justify="center">
            ...
            <v-col cols="auto" class="d-flex align-items-center">
              ...
              <v-btn icon variant="text" c class="mx-1" v-if="this.$i18n.locale === 'en' && width > pixels " >
                <v-img
