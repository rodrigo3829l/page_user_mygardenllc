<template>
  <v-navigation-drawer v-model="drawer" prominent>
    ...
    <div v-if="userStore.token">
      ...
      <v-list-item
        prepend-icon="mdi-cogs"
        @click="$router.push({ name: 'recomendations' })"
        ...
        <v-row align="center" justify="center">
          ...
          <v-col v-if="width > pixels" cols="auto">
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto">
                ...
                >
                  <v-icon size="15" color="white">{{ link.icon }}</v-icon
                  >{{ link.name }}
                </router-link>
                <router-link
                ...
                >
                  <v-icon size="15" color="white">mdi-login</v-icon
          ...
          <v-col cols="auto" class="d-flex align-items-center">
            <v-btn
              ...
              @click="changeLanguage('en')"
              class="mx-1"
              v-if="this.$i18n.locale === 'es' && width > pixels"
            >
              <v-img
            ...
            <v-btn
              ...
              @click="changeLanguage('es')"
              class="mx-1"
              v-if="this.$i18n.locale === 'en' && width > pixels"
            >
              <v-img
