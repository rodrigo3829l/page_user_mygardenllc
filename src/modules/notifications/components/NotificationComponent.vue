      ...
      <v-col>
        <v-row class="d-flex flex-column">
          <v-col>
            ...
            <h4 class="text-h6 font-weight-bold" :class="titleClass">
              {{ notification.tittle }}
            </h4>
            <p>{{ notification.message }}</p>
            <p>
              {{ notification.userId.name }}
              {{ notification.userId.apellidoP }}
              {{ notification.userId.apellidoM }}
            </p>
            <p>{{ notification.userId.email }}</p>
            <!-- Solo el nombre del servicio con el color dinámico -->
            <p class="font-weight-bold" :class="titleClass">
              {{ notification.serviceId.service.name }}
            </p>
