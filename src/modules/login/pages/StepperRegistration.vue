        ...
        <v-col cols="12" sm="8" md="8" lg="16">
            <v-card class="elevation-12">
                <v-stepper alt-labels v-model="step" :items="items" hide-actions>
                    ...
                    " v-model="formData.nombre" required :error-messages="errors.nombre" variant="underlined" color="green-darken-3"></v-text-field>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-text-field :label="
                      $t('registration.personalInformation.lastNameString')
                    " v-model="formData.apellidoPaterno" required :error-messages="errors.apellidoPaterno" variant="underlined" color="green-darken-3"></v-text-field>
                            </v-col>
                            <v-col cols="12" md="6">
                            ...
                            <v-col cols="12" md="6">
                                <v-select :label="$t('registration.personalInformation.genderString')" v-model="formData.sexo" :items="[
                      $t('registration.personalInformation.maleString'),
                      $t('registration.personalInformation.femaleString'),
                    ]" required variant="underlined" color="green-darken-3"></v-select>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-row align="center">
                                    <v-col cols="4">
                                        <v-select v-model="formData.lada" :items="['+1 (USA)', '+52 (Mexico)']" :label="
                          $t('registration.personalInformation.ladeString')
                        " :error-messages="errors.lada" variant="underlined" color="green-darken-3"></v-select>
                                    </v-col>
                                    <v-col cols="8">
                                        <v-text-field :label="
                          $t('registration.personalInformation.phoneString')
                        " v-model="formData.phone" required :error-messages="errors.phone" type="number" variant="underlined" color="green-darken-3" :prefix="
                  ...
                  >
                    <div class="image-placeholder">
                      {{
                        ...
                        <v-row>
                            <v-col cols="12" md="6">
                                <v-file-input @change="handleImageUpload" accept="image/*" :error-messages="errors.image" :label="
        $t('registration.personalInformation.selectPictureString')
      "></v-file-input>
                                <v-btn @click="openCamera" color="green-darken-3" class="mt-2">
                                    Abrir Cámara
                                </v-btn>
                            </v-col>

                            <v-col cols="12" md="6">
                                <video ref="video" width="200" height="150" autoplay v-if="cameraActive"></video>

                                <v-img v-else-if="formData.imagen" :src="formData.imagen" alt="Selected Image" class="image-preview" contain></v-img>
          ...
          $t("registration.personalInformation.selectImageString")
                                ...
                                <v-btn @click="capturePhoto" color="green-darken-3" class="mt-2" v-if="cameraActive">
                                    Capturar Foto
                                </v-btn>
                            </v-col>
                        </v-row>
                    ...
                    <template v-slot:item.2>
                        ...
                        <v-row>
                            <v-col>
                                ...
                                <v-select v-model="formData.street" :label="$t('registration.LocationDetails.streetString')" required :disabled="!cpValidate" :error-messages="errors.street" variant="underlined" color="green-darken-3" :items="[
                      'Peachtree Street',
                      'Marietta Street',
                      'Decatur Street',
                      'Spring Street',
                      ...
                      'Whittenham Clse',
                                ...
                                <v-text-field v-model="formData.neighborhood" :label="
                      $t('registration.LocationDetails.neighborhoodString')
                    " required :disabled="!cpValidate" :placeholder="
                      $t(
                        'registration.LocationDetails.placeholderNeighboorhood',
                      )
                    " :error-messages="errors.neighborhood" variant="underlined" color="green-darken-3"></v-text-field>

                                <v-text-field v-model="formData.houseNumber" :label="$t('registration.LocationDetails.houseString')" required :disabled="!cpValidate" :error-messages="errors.houseNumber" variant="underlined" color="green-darken-3" :placeholder="
                  ...
                  ></v-text-field> -->
                                ...
                                <v-text-field v-model="formData.password" :label="$t('registration.userdata.passwordString')" required :error-messages="errors.password" variant="underlined" color="green-darken-3" :placeholder="$t('registration.userdata.helloString')" :append-inner-icon="
                      passwordVisible ? 'mdi-eye-off' : 'mdi-eye'
                    " :type="passwordVisible ? 'text' : 'password'" outlined @click:append-inner="togglePasswordVisibility" @input="checkStrength"></v-text-field>
                      ...
                      " class="orange--text">{{ $t("registration.userdata.goodPassword") }}</span>
                                    <span v-else class="green--text">{{
                      $t("registration.userdata.excellentPassword")
                    }}</span>
                                </div>

                                <v-text-field v-model="formData.confirmPassword" :label="$t('registration.userdata.confirmPasswordString')" required :error-messages="errors.confirmPassword" variant="underlined" color="green-darken-3" :placeholder="$t('registration.userdata.helloString')" :append-inner-icon="
                      passwordVisibleConfirm ? 'mdi-eye-off' : 'mdi-eye'
                    " :type="passwordVisibleConfirm ? 'text' : 'password'" outlined @click:append-inner="togglePasswordVisibilityConfirm"></v-text-field>
