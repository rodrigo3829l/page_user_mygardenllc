  ...
  <v-container class="container">
    <v-card>
      ...
      <v-card-text>
        ...
        <br />
        <p>{{ service.Clificacion }}</p>
        <br />
        <v-divider></v-divider>
        <br />
        <label>{{
          $t("service.pages.scheduleService.descriptionString")
        }}</label>
        <br />
        <v-textarea
          outlined
      ...
      <v-card-actions class="d-flex justify-space-between">
        ...
        <v-btn color="green darken-1" @click="validate()" text>{{
          $t("service.pages.scheduleService.scheduleString")
        }}</v-btn>
      </v-card-actions>
    </v-card>
...
export default {
  ...
  methods: {
    ...
    processImage(file) {
      ...
      this.errors.image = !file
        ? this.$t("service.pages.scheduleService.script.imageRequired")
        : "";
      ...
      try {
        ...
        const datos = {
          ...
          img: {
            ...
            secure_url:
              "https://res.cloudinary.com/dui4i9f4e/image/upload/v1697990498/logos/p3xyl9xetmmg6vlamwkt.jpg",
          },
          typeReserve: "online",
          scheduledTime: date,
        };
