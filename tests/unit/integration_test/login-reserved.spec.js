...
describe('Integración: Login + Reserva de Servicios', () => {
  ...
  it('Debería redirigir al home si hay sesión iniciada', async () => {
    mockUserStore.token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c';
    await initializeComponent();
