...
const i18n = createI18n({
  locale: 'en',
  messages: { en: { faqs: { titleString: 'FAQs', buttonShowAllString: 'Show All', buttonHideAllString: 'Hide All' } } },
});
...
describe('FAQs.vue', () => {
  ...
  it('muestra todas las preguntas al hacer clic en "Show All"', async () => {
    await initializeComponent();
    await wrapper.setData({ faqs: [{ question: 'Q1?', answer: 'A1' }, { question: 'Q2?', answer: 'A2' }] });
